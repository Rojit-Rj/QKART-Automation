...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            WebElement searchbox = driver.findElement(By.xpath("(//div/input[@name='search'])[1]"));
            searchbox.click();
            searchbox.clear();
    ...
    public Boolean clickCheckout() {
        ...
        try {
            ...
            WebElement checkoutbutton =
                    driver.findElement(By.xpath("//div/button[text()='Checkout']"));
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            // here we need to remove the item completely from the
            // cart)*--//*[@data-testid='RemoveOutlinedIcon']
