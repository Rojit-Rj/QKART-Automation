...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Failed", "TestCase1");
            return false;
        }
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "EndTeseCase", "TestCase1");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Failed", "TestCase2");
            return false;
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "Failed", "TestCase3");
            return false;
        }
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                logStatus("Step Success", "Validated presence of drop down",
                        status ? "PASS" : "FAIL");
                        takeScreenshot(driver, "Failed", "TestCase4");
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("TestCase 5", "Test Case Failure. Happy Flow Test Failed", "FAIL");
            takeScreenshot(driver, "Failed", "TestCase6");
        }
        ...
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        if (!status) {
            logStatus("StepFailure", "User Perform Login Fail", status ? "PASS" : "FAIL");
            logStatus("EndTestCase", "TesTCase6:Happy Flow Test Failed: ",
                    status ? "PASS" : "FAIL");
                    takeScreenshot(driver, "Failed", "TestCase6");
        }
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            logStatus("End TestCase",
                    "Test Case 7: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                    status ? "PASS" : "FAIL");
                    takeScreenshot(driver, "Failed", "TestCase7");
            return false;
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 8", "Test Case Failure. Add Test Case for Multitab Scenario",
                    "FAIL");
            takeScreenshot(driver, "Failed", "TestCase8");
        }
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!currenUrl.equals("https://crio-qkart-frontend-qa.vercel.app/"))

        {
            logStatus("Step Failure", "Verifiying current URL failed", "FAIL");
            takeScreenshot(driver, "Failed", "TestCase9");
            return false;
        }
        Set<String> setWindows = driver.getWindowHandles();
        String[] windows = setWindows.toArray(new String[setWindows.size()]);
        driver.switchTo().window(windows[1]);
        WebElement privacyPolicy = driver.findElement(By.xpath("//h2[text()='Privacy Policy']"));

        if (!privacyPolicy.isDisplayed()) {
            logStatus("Step Failure", "Privacy Policy content is not displaying", "FAIL");
            return false;
        ...
        if (!tos.isDisplayed()) {
            logStatus("Step Failure", "Terms of Service content is not displaying", "FAIL");
            takeScreenshot(driver, "Failed", "TestCase9");
            return false;
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
       ...
       // Thread.sleep(3000);
        ...
        buyNow.click();
        wait.until(
                (ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/checkout")));
